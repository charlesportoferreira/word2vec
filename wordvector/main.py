...
class Main:
    ...
    def main(self):
        ...
        w2v = Word2VectorUtil(aggregator=command_line.aggregator, model_path=mo_foname, binary=command_line.isBin)
        ...
        for folder in folders:  # reading class folders
            ...
            for file in files:
                ...
                if len(doc_vector) == 0:
                    doc_without_vector = doc_without_vector + 1
